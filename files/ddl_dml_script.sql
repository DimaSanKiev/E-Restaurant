...
VALUES ('SOUP',
        'Soup is a primarily liquid food, served warm (some kinds are cool cool or cold), that is made by combining ingredients such as meat and vegetables with stock, juice, water, or another liquid.');
INSERT INTO dish_category (NAME, DESCRIPTION)
VALUES ('SALAD',
...
INSERT INTO dish_category (NAME, DESCRIPTION)
VALUES ('DESSERT',
        'Dessert id the sweet course eaten at the end of a meal. It is the fourth "meal" of the day following breakfast, lunch, and dinner.');
INSERT INTO dish_category (NAME, DESCRIPTION)
VALUES ('DRINK',
        'Different cold beverages such as: juices, lemonades, soda, and also some hot drinks like tea, espresso, latte, mochaccino.');
