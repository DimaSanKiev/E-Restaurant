...
CREATE TABLE dish (
  ...
  dish_category_id INTEGER REFERENCES dish_category (id) ON DELETE CASCADE
);
...
CREATE TABLE orders (
  ...
  orders_status_id    INTEGER DEFAULT 1 REFERENCES orders_status (id) ON DELETE CASCADE,
