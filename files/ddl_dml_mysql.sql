...
VALUES ('Cream of mushroom soup',
        ...
        5.40, TRUE, TRUE, LOAD_FILE('resources/images/02_Cream-Of-Mushroom-Soup.jpg'), 1);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Miso soup',
        'Miso soup is a traditional Japanese soup consisting of a stock called "dashi" into which softened miso paste is mixed.',
        3.60, TRUE, TRUE, LOAD_FILE('resources/images/03_Miso-Soup.jpg'), 1);
...
VALUES ('Greek Salad',
        ...
        5.50, TRUE, TRUE, LOAD_FILE('resources/images/04_Greek-Salad.jpg'), 2);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Avocado and Tuna Tapas',
        ...
        7.30, TRUE, TRUE, LOAD_FILE('resources/images/05_Avocado-Tuna-Tapas.jpg'), 2);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Caesar salad',
        ...
        4.30, TRUE, TRUE, LOAD_FILE('resources/images/06_Caesar-Salad.jpg'), 2);
...
VALUES ('Baked Spaghetti',
        ...
        7.20, TRUE, TRUE, LOAD_FILE('resources/images/07_Baked-Spaghetti.jpg'), 3);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Beef Bourguignon',
        ...
        8.20, TRUE, TRUE, LOAD_FILE('resources/images/08_Beef-Bourguignon.jpg'), 3);
INSERT INTO dish (NAME, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Wild Salmon',
        'Grilled whole wild salmon, stuffed with a relish made of preserved lemons, parsley, dill, and shallots.',
        8.90, TRUE, TRUE, LOAD_FILE('resources/images/09_Wild-Salmon.jpg'), 3);
...
VALUES ('Chocolate Fondue',
        ...
        5.10, TRUE, TRUE, LOAD_FILE('resources/images/10_Chocolate-Fondue.jpg'), 4);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
