...
VALUES ('Tomato Soup',
        ...
        4.20, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\01_Tomato-Soup.jpg'),
        1);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Cream of mushroom soup',
        ...
        5.40, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\02_Cream-Of-Mushroom-Soup.jpg'), 1);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Miso soup',
        'Miso soup is a traditional Japanese soup consisting of a stock called "dashi" into which softened miso paste is mixed.',
        3.60, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\03_Miso-Soup.jpg'), 1);
...
VALUES ('Greek Salad',
        ...
        5.50, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\04_Greek-Salad.jpg'), 2);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Avocado and Tuna Tapas',
        ...
        7.30, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\05_Avocado-Tuna-Tapas.jpg'), 2);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Caesar salad',
        ...
        4.30, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\06_Caesar-Salad.jpg'), 2);
...
VALUES ('Baked Spaghetti',
        ...
        7.20, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\07_Baked-Spaghetti.jpg'), 3);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Beef Bourguignon',
        ...
        8.20, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\08_Beef-Bourguignon.jpg'), 3);
INSERT INTO dish (NAME, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Wild Salmon',
        'Grilled whole wild salmon, stuffed with a relish made of preserved lemons, parsley, dill, and shallots.',
        8.90, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\09_Wild-Salmon.jpg'), 3);
...
VALUES ('Chocolate Fondue',
        ...
        5.10, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\10_Chocolate-Fondue.jpg'), 4);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Tapioca Pudding',
        ...
        4.20, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\11_Tapioca-Pudding.jpg'), 4);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Fruit Salad',
        'Blueberry, peach, nectarine fruit salad seasoned with fresh thyme, ginger, and lemon juice.',
        4.40, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\12_Fruit-Salad.jpg'), 4);

-- drinks --
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Latte',
        'A Latte is a type of coffee made with espresso and hot steamed milk, milkier than a cappuccino.',
        4.90, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\13_Latte.jpg'), 5);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Tea',
        'Aromatic beverage prepared by pouring hot water over cured leaves of tea leaves.',
        3.40, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\14_Tea.jpg'), 5);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Fresh Juice',
        'Natural and healthy juices from different fruits and vegetables. Can be mixed in different variations.',
        4.50, TRUE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\15_Juice.jpg'), 5);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Cola',
        'A typical brown carbonated drink that is flavoured with an extract of cola nuts, or with a similar flavouring.',
        2.90, FALSE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\16_Cola.jpg'), 5);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Mineral water',
        'Water that contains mineral salts and natural carbon dioxide.',
        4.50, FALSE, TRUE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\17_Mineral-Water.jpg'), 5);
INSERT INTO dish (name, description, price, kitchenmade, available, photo, dish_category_id)
VALUES ('Beer',
        'An alcoholic drink made from yeast-fermented malt flavoured with hops.',
        5.50, FALSE, FALSE, FILE_READ('E:\Dima\Information\IT\MyProjects\toGitHub\E-Restaurant\files\images\18_Beer.jpg'), 5);
